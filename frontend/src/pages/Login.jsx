  ...
  return (
    <div className="glint-root">
      <style>{`
        ...
        .glint-field-row label { margin-bottom: 0; }
        ...
        .glint-forgot:hover { border-color: var(--lilac); }
      ...
      <div className="glint-brand" aria-hidden="true">
        ...
        <div className="glint-brand-copy">
          ...
          <p>
            Your feed's been waiting. Log back in to catch up on every moment
            you missed and keep the conversation going.
          </p>
        </div>
      ...
      <div className="glint-form-panel">
        <div className="glint-card">
          ...
          <h2>Log in to SnapGram</h2>
          <p className="glint-sub">Welcome back — enter your details to continue.</p>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="glint-field">
              <div className="glint-field-row">
                <label htmlFor="password">Password</label>
                <Link to="/forgot-password" className="glint-forgot">
                  Forgot password?
                </Link>
              </div>
              <div
            ...
            <button type="submit" className="glint-submit" disabled={loading}>
          ...
          <p className="glint-login">
            ...
            <Link to="/register" className="glint-login-link">
              Sign up
            </Link>
          </p>
        </div>
...
const GlintMark = ({ className }) => (
  ...
  >
    ...
    <circle
      ...
      cy="20"
      r="17"
      stroke="url(#glint-mark-gradient-login)"
      strokeWidth="2.4"
    />
    <path
      d="M22.5 8L13 22.5H19L17 32L27 17H21L22.5 8Z"
      fill="url(#glint-mark-gradient-login)"
    />
  </svg>
);
